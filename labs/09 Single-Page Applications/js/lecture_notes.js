...
document.querySelector('nav > ul > li:nth-child(1)').onclick = function() {
  ...
  document.querySelector('#addPage input').value = document.querySelector(
      '#editPage input').value;
  document.querySelector('#addPage textarea').value = document.querySelector(
      '#editPage textarea').value;
...
document.querySelector('nav > ul > li:nth-child(2)').onclick = function() {
  ...
  document.querySelector('#editPage input').value = document.querySelector(
      '#addPage input').value;

  document.querySelector('#editPage textarea').value = document.querySelector(
      '#addPage textarea').value;
